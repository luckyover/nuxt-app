...
const fetchLogin = async () => {
    await post('/login',data); //lưu thông tin login
};
  ...
  <div class="bg-gray-100 flex justify-center items-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <form method="POST">
            ...
            <button type="button"
                class="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg focus:outline-none focus:bg-blue-600" @click=fetchLogin>
                Login
            </button>
        </form>
    </div>
